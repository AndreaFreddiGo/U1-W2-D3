...
console.log('La massa totale dei personaggi è', crewMass)
...
starWarsCharacters[4].mass = 180
console.log(
  starWarsCharacters[4].name,
  'ha mangiato troppi muffin ed è ingrassata fino a pesare',
